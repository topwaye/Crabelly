...
When reading the Linux source code, you do not know where you are. There are only a small number of people who might know the entire kernel code in the Linux core team. Linux is a kernel that you just cannot read through. That is a good news, meaning no man is an expert, each is a part of the main. No man could be a hero who controls everything in the Linux world.
