...
Another question: Do a share map and a copy-on-write map coexist at the same level ? Absolutely not. If they do, a bug follows, meaning a map can only be shared the split part, not the unsplit part in this undesirable situation.
