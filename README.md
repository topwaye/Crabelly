...
When reading the Linux source code, you cannot tell where you are. There are only a small number of people who might know the entire kernel code in the Linux core team. Linux is a kernel that you just cannot read through. That is a good news, meaning no man is an expert, each is a part of the main. No man could be a hero who takes charge of everything in the Linux world.
